...
- [ ] 4.5 Validate real requests in the selected languages. Added `python -m jarvis.stt.diagnostics` with opt-in transcript display and timing metrics; official English sample 0 transcribed successfully (6.625 s audio, 0.315 s inference in this run). User microphone/accent validation remains pending.
